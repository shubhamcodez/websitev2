...
const Resume = () => {
  return (
    <div className="container">
      <header>
        <h1>Shubham Singh</h1>
        <p>New York City, NY | shubham.singh@nyu.edu | <a href="https://github.com/shubhamcodez" target="_blank" rel="noopener noreferrer">Github</a> | <a href="https://www.kaggle.com/shubhamcodez" target="_blank" rel="noopener noreferrer">Kaggle</a> | <a href="https://www.linkedin.com/in/shubhamsinghnyu" target="_blank" rel="noopener noreferrer">LinkedIn</a> | 9179140131 | <a href="https://scholar.google.com" target="_blank" rel="noopener noreferrer">Google Scholar</a></p>
      </header>

      <section id="education">
        <h2>Education</h2>
        <p><strong>Master of Science in Computer Engineering, New York University</strong> (Expected: May 2025)<br/>
        <em>Courses: Probability and Statistics, Algorithmic Trading, Quantitative Strategies, Machine Learning, Deep Learning</em></p>
        <p><strong>Bachelor in Computer Science, Bharati Vidyapeeth University</strong> (June 2023)</p>
      </section>
